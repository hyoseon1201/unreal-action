...
struct Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics
{
	struct _Script_W1_eventOnPercentChangedDelegate_Parms
	{
		float NewPercent;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::NewProp_NewPercent = { "NewPercent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_W1_eventOnPercentChangedDelegate_Parms, NewPercent), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::NewProp_NewPercent,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_W1, nullptr, "OnPercentChangedDelegate__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::_Script_W1_eventOnPercentChangedDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::_Script_W1_eventOnPercentChangedDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature_Statics::FuncParams);
	}
...
void FOnPercentChangedDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnPercentChangedDelegate, float NewPercent)
{
	...
	_Script_W1_eventOnPercentChangedDelegate_Parms Parms;
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UPawnUIComponent_Statics::NewProp_OnCurrentHealthChanged = { "OnCurrentHealthChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPawnUIComponent, OnCurrentHealthChanged), Z_Construct_UDelegateFunction_W1_OnPercentChangedDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnCurrentHealthChanged_MetaData), NewProp_OnCurrentHealthChanged_MetaData) }; // 378267673
...
struct Z_CompiledInDeferFile_FID_unreal_action_W1_Source_W1_Components_UI_PawnUIComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPawnUIComponent, UPawnUIComponent::StaticClass, TEXT("UPawnUIComponent"), &Z_Registration_Info_UClass_UPawnUIComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPawnUIComponent), 1217079283U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_unreal_action_W1_Source_W1_Components_UI_PawnUIComponent_h_1791630641(TEXT("/Script/W1"),

...
W1_API UEnum* Z_Construct_UEnum_W1_EToggleDamageType();
...
static UEnum* EToggleDamageType_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_EToggleDamageType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_W1_EToggleDamageType, (UObject*)Z_Construct_UPackage__Script_W1(), TEXT("EToggleDamageType"));
	}
...
struct Z_Construct_UEnum_W1_EToggleDamageType_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_W1_EToggleDamageType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_W1,
	nullptr,
	"EToggleDamageType",
	"EToggleDamageType",
	Z_Construct_UEnum_W1_EToggleDamageType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_W1_EToggleDamageType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_W1_EToggleDamageType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_W1_EToggleDamageType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_W1_EToggleDamageType()
{
	if (!Z_Registration_Info_UEnum_EToggleDamageType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EToggleDamageType.InnerSingleton, Z_Construct_UEnum_W1_EToggleDamageType_Statics::EnumParams);
	}
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UPawnCombatComponent_ToggleWeaponCollision_Statics::NewProp_ToggleDamageType = { "ToggleDamageType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PawnCombatComponent_eventToggleWeaponCollision_Parms, ToggleDamageType), Z_Construct_UEnum_W1_EToggleDamageType, METADATA_PARAMS(0, nullptr) }; // 2821192778
...
struct Z_Construct_UClass_UPawnCombatComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UPawnCombatComponent_ToggleWeaponCollision, "ToggleWeaponCollision" }, // 1562243244
	};
...
struct Z_CompiledInDeferFile_FID_unreal_action_W1_Source_W1_Components_Combat_PawnCombatComponent_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EToggleDamageType_StaticEnum, TEXT("EToggleDamageType"), &Z_Registration_Info_UEnum_EToggleDamageType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2821192778U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPawnCombatComponent, UPawnCombatComponent::StaticClass, TEXT("UPawnCombatComponent"), &Z_Registration_Info_UClass_UPawnCombatComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPawnCombatComponent), 71861271U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_unreal_action_W1_Source_W1_Components_Combat_PawnCombatComponent_h_3793696566(TEXT("/Script/W1"),
	...
	nullptr, 0,
	Z_CompiledInDeferFile_FID_unreal_action_W1_Source_W1_Components_Combat_PawnCombatComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_unreal_action_W1_Source_W1_Components_Combat_PawnCombatComponent_h_Statics::EnumInfo));
// End Registration

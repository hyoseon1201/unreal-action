...
#include "W1/AbilitySystems/AbilityTasks/AbilityTask_WaitSpawnEnemies.h"
...
W1_API UClass* Z_Construct_UClass_UAbilityTask_WaitSpawnEnemies();
W1_API UClass* Z_Construct_UClass_UAbilityTask_WaitSpawnEnemies_NoRegister();
...
struct Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics
{
	struct _Script_W1_eventWaitSpawnEnemiesDelegate_Parms
	{
		TArray<AW1EnemyCharacter*> SpawnedEnemies;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "AbilitySystems/AbilityTasks/AbilityTask_WaitSpawnEnemies.h" },
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::NewProp_SpawnedEnemies_Inner = { "SpawnedEnemies", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_AW1EnemyCharacter_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::NewProp_SpawnedEnemies = { "SpawnedEnemies", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_W1_eventWaitSpawnEnemiesDelegate_Parms, SpawnedEnemies), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SpawnedEnemies_MetaData), NewProp_SpawnedEnemies_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::NewProp_SpawnedEnemies_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::NewProp_SpawnedEnemies,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_W1, nullptr, "WaitSpawnEnemiesDelegate__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::_Script_W1_eventWaitSpawnEnemiesDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::_Script_W1_eventWaitSpawnEnemiesDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FWaitSpawnEnemiesDelegate_DelegateWrapper(const FMulticastScriptDelegate& WaitSpawnEnemiesDelegate, TArray<AW1EnemyCharacter*> const& SpawnedEnemies)
{
	struct _Script_W1_eventWaitSpawnEnemiesDelegate_Parms
	{
		TArray<AW1EnemyCharacter*> SpawnedEnemies;
	};
	_Script_W1_eventWaitSpawnEnemiesDelegate_Parms Parms;
...
struct Z_Construct_UFunction_UAbilityTask_WaitSpawnEnemies_WaitSpawnEnemies_Statics
{
	struct AbilityTask_WaitSpawnEnemies_eventWaitSpawnEnemies_Parms
	{
		...
		TSoftClassPtr<AW1EnemyCharacter>  SoftEnemyClassToSpawn;
		int32 NumToSpawn;
		FVector SpawnOrigin;
...
DEFINE_FUNCTION(UAbilityTask_WaitSpawnEnemies::execWaitSpawnEnemies)
{
	...
	P_GET_SOFTCLASS(TSoftClassPtr<AW1EnemyCharacter> ,Z_Param_SoftEnemyClassToSpawn);
...
struct Z_Construct_UClass_UAbilityTask_WaitSpawnEnemies_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "Comment", "/**\n * \n */" },
#endif
		{ "IncludePath", "AbilitySystems/AbilityTasks/AbilityTask_WaitSpawnEnemies.h" },
		{ "ModuleRelativePath", "AbilitySystems/AbilityTasks/AbilityTask_WaitSpawnEnemies.h" },
	};
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAbilityTask_WaitSpawnEnemies_Statics::NewProp_OnSpawnFinished = { "OnSpawnFinished", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilityTask_WaitSpawnEnemies, OnSpawnFinished), Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnSpawnFinished_MetaData), NewProp_OnSpawnFinished_MetaData) }; // 2216190100
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAbilityTask_WaitSpawnEnemies_Statics::NewProp_DidNotSpawn = { "DidNotSpawn", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilityTask_WaitSpawnEnemies, DidNotSpawn), Z_Construct_UDelegateFunction_W1_WaitSpawnEnemiesDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DidNotSpawn_MetaData), NewProp_DidNotSpawn_MetaData) }; // 2216190100
...
template<> W1_API UClass* StaticClass<UAbilityTask_WaitSpawnEnemies>()
{
	return UAbilityTask_WaitSpawnEnemies::StaticClass();
}

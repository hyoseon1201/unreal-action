...
struct Z_Construct_UFunction_UEnemyUIComponent_RegisterEnemyDrawnWidget_Statics
{
	...
	{
		UW1WidgetBase* InWidgetToRegister;
	};
#if WITH_METADATA
...
{
	P_GET_OBJECT(UW1WidgetBase,Z_Param_InWidgetToRegister);
	P_FINISH;
	P_NATIVE_BEGIN;
...
struct Z_Construct_UClass_UEnemyUIComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UEnemyUIComponent_RegisterEnemyDrawnWidget, "RegisterEnemyDrawnWidget" }, // 4010919348
		{ &Z_Construct_UFunction_UEnemyUIComponent_RemoveEnemyDrawnWidgetsIfAny, "RemoveEnemyDrawnWidgetsIfAny" }, // 3588820416
	};
...
struct Z_CompiledInDeferFile_FID_unreal_action_W1_Source_W1_Components_UI_EnemyUIComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEnemyUIComponent, UEnemyUIComponent::StaticClass, TEXT("UEnemyUIComponent"), &Z_Registration_Info_UClass_UEnemyUIComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnemyUIComponent), 2844688537U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_unreal_action_W1_Source_W1_Components_UI_EnemyUIComponent_h_1861172478(TEXT("/Script/W1"),

...
// IWYU pragma: private, include "AbilitySystems/Abilities/W1EnemyGameplayAbility.h"
...
public: \
	DECLARE_CLASS(UW1EnemyGameplayAbility, UW1GameplayAbility, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/W1"), NO_API) \
...
private: \
	...
	UW1EnemyGameplayAbility(const UW1EnemyGameplayAbility&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UW1EnemyGameplayAbility); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UW1EnemyGameplayAbility); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UW1EnemyGameplayAbility) \
...
template<> W1_API UClass* StaticClass<class UW1EnemyGameplayAbility>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_unreal_action_W1_Source_W1_AbilitySystems_Abilities_W1EnemyGameplayAbility_h

...
#include "AbilitySystems/Abilities/HeroGameplayAbility_TargetLock.h"
...
void UHeroGameplayAbility_TargetLock::OnTargetLockTick(float DeltaTime)
{
	if (!CurrentLockedActor || 
		UW1FunctionLibrary::NativeDoesActorHaveTag(CurrentLockedActor, W1GameplayTags::Shared_Status_Dead) ||
		UW1FunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), W1GameplayTags::Shared_Status_Dead))
	{
	...
	const bool bShouldOverrideRotation = 
		!UW1FunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), W1GameplayTags::Player_Status_Rolling)
		&&
		!UW1FunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), W1GameplayTags::Player_Status_Blocking);
...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	if (InSwitchDirectionTag == W1GameplayTags::Player_Event_SwitchTarget_Left)
	{
...
void UHeroGameplayAbility_TargetLock::DrawTargetLockWidget()
{
	...
	{
		checkf(TargetLockWidgetClass, TEXT("Forgot to assign a valid widget class in"));

		DrawnTargetLockWidget = CreateWidget<UW1WidgetBase>(GetHeroControllerFromActorInfo(), TargetLockWidgetClass);
